...
public class TreeSetEntry implements java.io.Serializable {
	public static final TreeSetEntry SYMBOLICTREESETENTRY = new TreeSetEntry(); //field added to execute the hybridRepOK.
	public static final int SYMBOLICINT = (int) Integer.MIN_VALUE; //field added to execute the hybridRepOK.

	
	
	private static final long serialVersionUID=6495900899527469822L;
