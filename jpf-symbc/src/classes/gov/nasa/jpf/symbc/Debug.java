...
public class Debug {
    ...
    public static Object makeSymbolicRef(String name, Object v) {
    	System.out.println("In SYMBC WITH Class = " + v.getClass().getName());
    	assert (v!=null); // needed for type info
    	if (Verify.randomBool()) {
    		System.out.println("In makefieldssymbolic");
    		makeFieldsSymbolic(name, v);
    		
    	}
    	else {
    		System.out.println("In makesymbolicnull");
    		v = makeSymbolicNull(name);
//    		System.out.println("After makesymbolicnull with class = " + v.getClass().getSimpleName());
    	}
    	return v;
    }
